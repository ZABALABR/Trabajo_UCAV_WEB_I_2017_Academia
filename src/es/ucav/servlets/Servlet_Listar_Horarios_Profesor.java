 ...
 */
@WebServlet("/horarios_profesor")
public class Servlet_Listar_Horarios_Profesor extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			ListaHorario = asignaturasDAO.Listar_Asignaturas_Profe(usuario);
			request.setAttribute("ListaHorario", ListaHorario);
			RequestDispatcher dispatcher;

			dispatcher = request.getRequestDispatcher("index_profesor.jsp");
