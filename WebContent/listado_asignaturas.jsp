   ...
   <%--  <h1>Hola Administrador <%=session.getAttribute("usuario") %></h1> --%>
    ...
    <h1>Gestión de asignaturas</h1>
        ...
        <br>
         <center>
        <h2>
            <a href="add_asignatura.jsp">Alta asignatura</a>
            &nbsp;&nbsp;&nbsp;
            
            <a href="alumnos_asignatura.jsp">Asignar alumnos</a>
            &nbsp;&nbsp;&nbsp;
                ...
                <tr>
                    ...
                    <td>
                       <%--  <a href="/edit?id=<c:out value='${profe.id_profesor}' />">Edit</a> --%>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="eliminar_asignatura?id_asignatura=<c:out value='${asignatura.id_asignatura}' />">Borrar</a>
                     </td>
                      <td>
                         &nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="horario_asignatura?id_asignatura=<c:out value='${asignatura.id_asignatura}' />">Asignar horario</a>
                      </td>
                      <td>   
                       &nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="profesor_asignatura?id_asignatura=<c:out value='${asignatura.id_asignatura}' />">Asignar profesor</a>
                         </td>
<%--                       <td>
                       &nbsp;&nbsp;&nbsp;&nbsp;
